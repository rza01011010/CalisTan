        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <?php
                if(isset($_POST['simpan'])){
                    ...
                    $random_name = generateRanmdomString(20);
                    ...
                    <tbody>
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a href="produk-detail.php?id=<?php echo $data ['id'] ?>" class="btn btn-info"><i class="fa-solid fa-search"></i></a>
                                        </td>
                                    </tr>
                        <?php
                                    $jumlah++;
